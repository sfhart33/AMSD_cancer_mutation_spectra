...
# save
  ...
  saveRDS(ancestry_amsd_output, "../outputs/ancestry_amsd_output_unweighted.rds")
  saveRDS(perms, "../outputs/ancestry_amsd_perms_unweighted.rds")

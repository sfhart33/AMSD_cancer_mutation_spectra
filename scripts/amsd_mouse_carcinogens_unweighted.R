...
# load data from mouse paper (processed into spectra)
  ...
  mouse_carcinogen_spectra <- mouse_carcinogen_counts # spectra
...
# save outputs
  ...
  saveRDS(mouse_amsd_output, "../outputs/mouse_amsd_output_unweighted.rds")
  saveRDS(perms, "../outputs/mouse_amsd_perms_unweighted.rds")